...
public interface PythonParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitSwitch(PythonParser.SwitchContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PythonParser#switch_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSwitch_stmt(PythonParser.Switch_stmtContext ctx);
	/**
	 * Visit a parse tree produced by {@link PythonParser#case_stmt}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCase_stmt(PythonParser.Case_stmtContext ctx);
	/**
