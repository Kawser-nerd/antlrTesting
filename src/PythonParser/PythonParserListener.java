...
public interface PythonParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterSwitch(PythonParser.SwitchContext ctx);
	/**
	 * Exit a parse tree produced by the {@code switch}
	 * labeled alternative in {@link PythonParser#small_stmt}.
	 * @param ctx the parse tree
	 */
	void exitSwitch(PythonParser.SwitchContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link PythonParser#switch_stmt}.
	 * @param ctx the parse tree
	 */
	void enterSwitch_stmt(PythonParser.Switch_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link PythonParser#switch_stmt}.
	 * @param ctx the parse tree
	 */
	void exitSwitch_stmt(PythonParser.Switch_stmtContext ctx);
	/**
	 * Enter a parse tree produced by {@link PythonParser#case_stmt}.
	 * @param ctx the parse tree
	 */
	void enterCase_stmt(PythonParser.Case_stmtContext ctx);
	/**
	 * Exit a parse tree produced by {@link PythonParser#case_stmt}.
	 * @param ctx the parse tree
	 */
	void exitCase_stmt(PythonParser.Case_stmtContext ctx);
	/**
